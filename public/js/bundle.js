...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmFpc2Fuam9vMyIsImEiOiJjazUyMW00eGgwemxoM25wN3Vsa2gzdG44In0.CMKYBMLmyvcNx1nDJq3PEw';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/raisanjoo3/ck522fdux43is1coy1dzllbd7',
    scrollZoom: false // center: [78.448077, 24.652807],
    // trackResize: true,
    // zoom: 10
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: type === 'data' ? 'http://127.0.0.1:1337/api/v1/users/updateMe' : 'http://127.0.0.1:1337/api/v1/users/updatePassword',
              data: data
            });
